...
package com.example.moleculightcameratest;
...
public class Camera2BasicFragment2 extends Fragment
     ...
     * {@link TextureView}.
     */
    private final TextureView.SurfaceTextureListener mSurfaceTextureListener1
...
//            openCamera(mTextureView.getWidth(), mTextureView.getHeight());
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        camButton.setText("cam 1");
        camButton.setOnClickListener(this);


        savePicture = (Button)view.findViewById(R.id.saveImage);
        savePicture.setText("Save 1");
    ...
    public void onResume() {
        ...
        if (mTextureView.isAvailable()) {
            ...
            mTextureView.setSurfaceTextureListener(mSurfaceTextureListener1);
        }
    }
       ...
       // assert activity != null;
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                Log.e(TAG, "setUpCameraOutputs: " +cameraId );
